...
// BankQueue class (multiple queues for tellers)
class BankQueue {
    ...
    public BankQueue(int tellers, int maxLength) {
        ...
        this.queues = new ArrayList<>(tellers);
    ...
    public boolean addCustomer(Customer customer) {
        ...
        try {
            ...
            if (shortestQueue.size() >= maxLength) {
                return false; // Queue full, customer leaves immediately
            }
